...
Contributors: pagebuildersandwich
Tags: wordpress page builder, visual editor, drag and drop builder, front-end page builder, homepage builder, landing page builder, site builder, visual builder, website builder, wysiwyg builder
...
Page Builder Sandwich is the friendliest WordPress drag and drop landing page builder for front-end editing.

== Description ==

Page Builder Sandwich is a <strong>front-end, drag & drop,WordPress visual page builder plugin</strong> that lets you create beautiful pages, and lets you design them effortlessly.
...
= 5.1.0 =
* Fixed: Templates issue 
* Fixed: Templates design issue 
...
* WordPress 6.1.1 tested
* Updated Freemius SDK
* Plugin welcome page content updated

= 4.5.8 =
* Updated to be compatible with WordPress 6.0.0

= 4.5.7 =
* Fixed CSS bugs

= 4.5.6 =
* Fixed admin welcome message
* Updated to be compatible with WordPress 5.9.3

= 4.5.5 =
* Enhanced: Updated Freemius SDK to v2.4.3

= 4.5.4 =
* Change: Map Element will now not display anything unless an API Key is provided
* Enhanced: Updated Freemius SDK to v2.4.0.1
* Fixed: Google Map API key error
* Fixed: Google Map API Key setting PHP notice
* Fixed: Javascript prevent default error when scrolling on the element list
